...
const services: Service[] = [
  {
    ...
    label: 'Vault',
    icon: 'lock_person',
    description: 'Password manager — store and share family passwords securely.',
    ...
    <div className="rounded-xl border border-outline-variant bg-surface-container overflow-hidden shadow-sm">
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-sm text-on-surface-variant mt-0.5">{service.description}</p>
        </div>
        <span
...
export default function Instructions() {
  useEffect(() => {
    ...
    return () => { document.title = 'Bear Family' }
  }, [])
